<template>
  <div class="app-container">
    ...
    <el-form :model="form" ref="form" label-width="100px" v-loading="formLoading" :rules="rules">
      ...
      <el-form-item label="专业" prop="majorName" required>
        <el-input v-model="form.majorName" placeholder="专业"></el-input>
      </el-form-item>
      <el-form-item label="班级" prop="className" required>
        <el-input v-model="form.className" placeholder="班级"></el-input>
      </el-form-item>
