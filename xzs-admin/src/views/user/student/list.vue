  ...
  <div class="app-container">
    <el-form :model="queryParam" ref="queryForm" :inline="true">
      ...
      <el-form-item label="年级：">
        <el-select v-model="queryParam.userLevel" placeholder="年级" @change="levelChange" clearable>
          <el-option v-for="item in levelEnum" :key="item.key" :value="item.key" :label="item.value"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="专业：" >
        <el-input v-model="queryParam.majorName"></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    submitForm () {
      ...
      console.log(this.queryParam.userLevel)
      console.log(this.queryParam.className)
      console.log(this.queryParam.majorName)
      this.search()
    },
    levelChange () {
    },
