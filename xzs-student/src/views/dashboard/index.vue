  ...
  <div style="margin-top: 10px">
    <el-row>
      <el-carousel :interval="5000" arrow="always" type="card">
        <el-carousel-item >
          <a href="https://www.sdut.edu.cn/"><img src="@/assets/carousel/1.png" class="carousel-img"></a>
        </el-carousel-item>
        <el-carousel-item >
          <a href="https://www.jlu.edu.cn/"><img src="@/assets/carousel/2.png" class="carousel-img"></a>
        </el-carousel-item>
        <el-carousel-item >
          <a href="https://www.ecnu.edu.cn/"><img src="@/assets/carousel/3.png" class="carousel-img"></a>
        </el-carousel-item>
        <el-carousel-item >
          <a href="/https://www.sdust.edu.cn/"><img src="@/assets/carousel/4.png" class="carousel-img"></a>
        </el-carousel-item>
      </el-carousel>
    </el-row>
    ...
    <el-row class="app-item-contain">
      <h3 class="index-title-h3">练习试卷</h3>
      <div style="padding-left: 15px">
