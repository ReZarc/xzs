<template>
  <div class="lowin  lowin-blue">
        ...
        <div class="lowin-box-inner">
          <el-form ref="form" :model="form" :rules="rules">
            ...
            <div class="lowin-group">
              <label>年级</label>
              <el-select class="lowin-input" v-model="form.userLevel" placeholder="年级">
    ...
    <div class="account-foot-copyright">
      <span>Rezarc 5cm/s 宁作我 ©2023 - 2024 All Rights Reserved</span>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    handleRegister () {
      let _this = this
      registerApi.register(this.form).then(function (result) {
        if (_this.form.userName.length >= 6) {
          if (_this.form.password.length >= 8) {
            ...
            _this.$message.error('密码长度小于8位！')
          }
        } else {
          _this.$message.error('用户名长度小于6位！')
        }
      })
    },
