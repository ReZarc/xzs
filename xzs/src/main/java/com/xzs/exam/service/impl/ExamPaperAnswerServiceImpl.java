...
import com.xzs.exam.domain.*;
import com.xzs.exam.domain.enums.ExamPaperAnswerStatusEnum;
import com.xzs.exam.domain.enums.ExamPaperTypeEnum;
import com.xzs.exam.domain.enums.QuestionTypeEnum;
import com.xzs.exam.domain.exam.ExamPaperTitleItemObject;
import com.xzs.exam.domain.other.ExamPaperAnswerUpdate;
import com.xzs.exam.domain.other.KeyValue;
import com.xzs.exam.domain.task.TaskItemAnswerObject;
import com.xzs.exam.repository.ExamPaperAnswerMapper;
import com.xzs.exam.repository.ExamPaperMapper;
import com.xzs.exam.repository.QuestionMapper;
import com.xzs.exam.repository.TaskExamCustomerAnswerMapper;
...
public class ExamPaperAnswerServiceImpl extends BaseServiceImpl<ExamPaperAnswer> implements ExamPaperAnswerService {
    ...
    @Override
    public PageInfo<ExamPaperAnswer> adminPage(com.xzs.exam.viewmodel.admin.paper.ExamPaperAnswerPageRequestVM requestVM) {
        return PageHelper.startPage(requestVM.getPageIndex(), requestVM.getPageSize(), "id desc").doSelectPageInfo(() ->
