...
import com.xzs.exam.exception.BusinessException;
import com.xzs.exam.repository.UserMapper;
...
public class UserServiceImpl extends BaseServiceImpl<User> implements UserService {
    ...
    @Override
    public List<User> selectByMajor(String majorName) {
        return userMapper.selectByMajor(majorName);
    }
